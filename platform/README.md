...
This repository is the TypeScript monorepo for Spyderbyte. The sole authoritative implementation
contract and progress ledger is [`SPYDERBYTE_IMPLEMENTATION_PLAN.md`](SPYDERBYTE_IMPLEMENTATION_PLAN.md).
...
provider decision gates recorded in the unified implementation plan.
...
The package directories and their responsibilities are defined in the unified implementation
