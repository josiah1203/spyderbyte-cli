...
- [`SPYDERBYTE_IMPLEMENTATION_PLAN.md`](../SPYDERBYTE_IMPLEMENTATION_PLAN.md) is the sole active implementation plan and progress ledger.
- [`SPYDERBYTE_DECLARATIVE_IMPLEMENTATION_PLAN.md`](../SPYDERBYTE_DECLARATIVE_IMPLEMENTATION_PLAN.md), [`IMPLEMENTATION_PLAN.md`](../IMPLEMENTATION_PLAN.md), [`SPYDERBYTE_PRODUCTION_IMPLEMENTATION_PLAN.md`](../SPYDERBYTE_PRODUCTION_IMPLEMENTATION_PLAN.md), and [`AGENTIC_PLATFORM_IMPLEMENTATION_PLAYBOOK.md`](../AGENTIC_PLATFORM_IMPLEMENTATION_PLAYBOOK.md) are historical planning records.
